...
describe NestedForm::Builder do
  describe "with no options" do
    ...
    it "should have an add link with arguments" do
      @builder.link_to_add("Add", :tasks, :foo => 'bar').should == '<a href="javascript:void(0)" class="add_nested_fields" data-association="tasks_with_foo_bar">Add</a>'
    end
